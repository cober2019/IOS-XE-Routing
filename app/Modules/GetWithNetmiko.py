...
def get_route_detials(netmiko_connection, prefix, protocol, with_mask=None):

    get_detials = []

    get_route = send_command(netmiko_connection, f'show ip route {prefix}')

    if protocol == 'O E1' or protocol == 'O E1' or protocol == 'O N1' or protocol == 'O N2':
    ...
    elif protocol == 'D' or protocol == 'EX':
        get_detials = send_command(netmiko_connection, f'show ip eigrp topology {with_mask}')
